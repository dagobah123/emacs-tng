...
`(magit-diff-hunk-heading-highlight ((t (:foreground ,text-hl-low :background ,background-hl-low :bold t ))))
...
`(magit-header-line ((t (:foreground ,text-hl :background ,background-hl :bold t ))))
...
`(org-level-1 ((t (:foreground ,text-match-2 :background ,background-match-3 :bold t ))))
...
`(org-tag ((t (:foreground ,text-match-2 :background ,background-match-2 :bold t ))))
