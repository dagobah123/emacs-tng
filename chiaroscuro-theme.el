...
;;;`(helm-buffer-archive ((t (:foreground ,text-mode-line :background unspecified ))))
`(helm-buffer-directory ((t (:foreground ,text-directory :background ,background-directory :bold t ))))
;;;`(helm-locate-finish ((t (:foreground ,text-low :background unspecified ))))
`(helm-buffer-file ((t (:foreground ,text-highlight-1 :background unspecified ))))
;;;`(helm-buffer-modified ((t (:foreground ,text-mode-line :background unspecified ))))
;;;`(helm-buffer-not-saved ((t (:foreground ,text-mode-line :background unspecified ))))
`(helm-buffer-process ((t (:foreground ,text-highlight-2 :background unspecified ))))
;;;`(helm-buffer-saved-out ((t (:foreground ,text-mode-line :background unspecified ))))
