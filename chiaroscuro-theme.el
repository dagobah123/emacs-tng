...
`(magit-diff-file-heading-highlight ((t (:foreground ,text-hl :background ,background-hl :bold t ))))
`(magit-diff-file-heading-selection ((t (:foreground ,text-hl :background ,background-hl :bold t ))))
`(magit-diff-hunk-heading ((t (:foreground ,text-low :background ,background-low ))))
`(magit-diff-hunk-heading-highlight ((t (:foreground ,text-hl :background ,background-hl ))))
