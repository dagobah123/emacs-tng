...
`(avy-lead-face ((t (:foreground ,text-match-2 :background ,background-match-2 :bold t ))))
`(avy-lead-face-0 ((t (:foreground ,text-match-2 :background ,background-match-2 :bold t ))))
`(avy-lead-face-1 ((t (:foreground ,text-match-2 :background ,background-match-2 :bold t ))))
`(avy-lead-face-2 ((t (:foreground ,text-match-2 :background ,background-match-2 :bold t ))))
...
`(magit-log-date ((t (:foreground ,text-hl-low ))))
