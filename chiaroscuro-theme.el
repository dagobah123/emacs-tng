...
;;;`(ivy-prompt-match ((t (:foreground "#000000" :background ,background-match-1 :bold t ))))
;;;`(ivy-subdir ((t (:bold t ))))
...
`(magit-blame-heading ((t (:foreground ,text-lower :background unspecified ))))
`(magit-blame-highlight ((t (:foreground ,text-low :background unspecified ))))
...
`(magit-diff-context ((t (:foreground ,text-normal :background unspecified ))))
`(magit-diff-context-highlight ((t (:foreground ,text-hl-lower :background ,background-magit ))))
`(magit-diff-file-heading ((t (:foreground ,text-highlight-2 :background unspecified :bold t ))))
...
`(magit-diff-hunk-heading ((t (:foreground ,text-low :background unspecified ))))
...
`(show-paren-match ((t (:foreground ,text-hl :background ,background-hl :bold t ))))
