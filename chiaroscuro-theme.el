...
`(diredfl-link-priv  ((t (:foreground ,text-diff-added-highlight :background ,background-diff-added-highlight ))))
...
`(diredfl-other-priv  ((t (:foreground ,text-diff-added-highlight :background ,background-diff-added-highlight ))))
