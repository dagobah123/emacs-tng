...
`(bold ((t (:foreground ,text-function :bold t ))))
`(bold-italic ((t (:foreground ,text-function :bold t ))))
`(bookmark-face ((t (:foreground ,text-normal :background unspecified ))))
`(comint-highlight-prompt ((t (:foreground ,text-function :background unspecified :bold t ))))
...
`(helm-source-header ((t (:foreground ,text-highlight :background unspecified :bold t :height 1.3 :family "Sans Serif" ))))
...
`(hydra-face-blue ((t (:foreground ,text-function :background unspecified :bold t ))))
`(hydra-face-red ((t (:foreground ,text-highlight :background unspecified :bold t ))))
...
`(lazy-highlight ((t (:foreground ,text-normal :background unspecified ))))
`(line-number ((t (:foreground ,text-whitespace :background unspecified ))))
`(line-number-current-line ((t (:foreground ,text-hl :background ,background-hl :bold t ))))
`(line-number-major-tick ((t (:foreground ,text-whitespace :background unspecified ))))
`(line-number-minor-tick ((t (:foreground ,text-whitespace :background unspecified ))))
...
`(magit-branch-current ((t (:foreground ,text-match-1 :background ,background-match-1 :bold t :box (:line-width 1 :color ,text-match-1) ))))
`(magit-branch-local ((t (:foreground ,text-match-2 :background ,background-match-2 :bold t :box (:line-width 1 :color ,text-match-2) ))))
`(magit-branch-remote ((t (:foreground ,text-match-3 :background ,background-match-3 :bold t :box (:line-width 1 :color ,text-match-3) ))))
`(magit-branch-remote-head ((t (:foreground ,text-match-3 :background ,background-match-3 :bold t :box (:line-width 1 :color ,text-match-3) :bold t :italic t ))))
`(magit-branch-upstream ((t (:foreground ,text-match-3 :background ,background-match-3 :bold t :box (:line-width 1 :color ,text-match-3) ))))
...
`(org-code ((t (:foreground ,text-function :background unspecified ))))
...
`(org-level-2 ((t (:foreground ,text-match-3 :background ,background-match-3 :bold t ))))
`(org-level-3 ((t (:foreground ,text-match-3 :background ,background-match-3 :bold t ))))
`(org-level-4 ((t (:foreground ,text-match-3 :background ,background-match-3 :bold t ))))
`(org-level-5 ((t (:foreground ,text-match-3 :background ,background-match-3 :bold t ))))
`(org-level-6 ((t (:foreground ,text-match-3 :background ,background-match-3 :bold t ))))
...
`(secondary-selection ((t (:foreground ,text-match-3 :background ,background-match-3 :bold t ))))
